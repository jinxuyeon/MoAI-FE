...
const FreeBoardBox = () => {
  const dummyFrees = [
    { id: 10, title: "오늘 날씨 진짜 좋네요 ☀️", author: "서예빈", date: "2025-05-01", views: 12, like: 25, ment: 2, imgUrl: "https://mblogthumb-phinf.pstatic.net/MjAyMjAyMDdfMjEy/MDAxNjQ0MTk0Mzk2MzY3.WAeeVCu2V3vqEz_98aWMOjK2RUKI_yHYbuZxrokf-0Ug.sV3LNWlROCJTkeS14PMu2UBl5zTkwK70aKX8B1w2oKQg.JPEG.41minit/1643900851960.jpg?type=w800" },
    { id: 2, title: "프론트엔드 공부 어떻게 시작했어요?", author: "익명", date: "2025-04-30", views: 55, like: 25, ment: 2 },
    ...
    { id: 1, title: "헬스장 같이 다니실 분 구해요", author: "익명", date: "2025-04-26", views: 50, like: 25, ment: 2, imgUrl: "https://mblogthumb-phinf.pstatic.net/MjAyMTEyMTJfODcg/MDAxNjM5MjQ5ODI4MDUz.RK_Ci32uWkgzv4sTTrlLowPU0bLil6qVMF1jTLKJHEAg.ra83ge0ifH7-tyv7mwa-3WOJL8sgOcSk3qQ80YUMvC0g.JPEG.41minit/1639153272211%EF%BC%8D7.jpg?type=w800" },
        ...
        {visibleFrees.map((free) => (
          <div key={free.id} className="free-list-item">
            ...
            <div className="free-list-content">
              <Link to={`/main/community/free/post/${free.id}`} className="free-link">
                {free.title}
