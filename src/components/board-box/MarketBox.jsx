...
const MarketBox = () => {
    const dummyMarkets = [
        {
            ...
            imgUrl: "https://image.yes24.com/goods/69750539/XL",
        },
        {
            id: 2,
            title: "알고리즘 책 판매",
            price: 18000,
            description: "거의 새책 상태입니다.",
            imgUrl: "https://www.hanbit.co.kr/data/books/B7707942187_l.jpg",
        },
        {
            id: 3,
            title: "컴퓨터 구조 교재",
            price: 12000,
            description: "필기 조금 있습니다.",
            imgUrl: "https://www.hanbit.co.kr/data/books/B9011295374_l.jpg",
        },
        {
            id: 4,
            title: "C++ 프로그래밍 책",
            price: 17000,
            description: "사용감 적음.",
            imgUrl: "https://contents.kyobobook.co.kr/sih/fit-in/400x0/pdt/9791156643647.jpg",
        },
        {
            id: 5,
            title: "C++ 프로그래밍 책",
    ...
    const visibleMarkets = dummyMarkets.slice(
        startIndex,
